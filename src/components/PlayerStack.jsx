    ...
    return (
        <div className="flex justify-end relative h-10 py-6 items-center border-b border-gray-300">
            ...
            <div className="w-16 md:w-12 lg:w-16 flex justify-center">
                <Link to={`/nations/${nation.name}`}>{nation ? <img src={nation.code.length > 2 ? nation.code : `https://flagsapi.com/${nation.code}/flat/64.png`} className="w-6"/> : <img src="https://flagsapi.com/DE/flat/64.png" className="w-6"/>}</Link>       
            </div>
            <div className="w-16 md:w-12 lg:w-16 flex justify-center">

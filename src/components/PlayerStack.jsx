export function PlayerStack({ short_name, overall, player_positions, pace, shooting, passing, dribbling, defending, physic }){
    return (
        <div className="flex justify-end relative h-10 py-6 items-center border-b border-gray-300">
            ...
            <span className="absolute text-xs md:text-base left-8 md:left-12 text-black tracking-wider">{short_name}</span>
            ...
            <span className="w-16 hidden md:flex justify-center font-medium ml-3">{player_positions.split(",")[0]}</span>
            <div className="w-16 flex justify-center font-medium">
                <span className="bg-gray-300 py-1 px-2">{overall}</span>
            </div>
            <div className="w-16 hidden md:flex justify-center font-medium">
